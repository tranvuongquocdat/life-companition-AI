...
const en: I18n = {
  greeting: "Hi! I'm Life Companion AI. Send a message, or type `/dive` for deep dive mode.",
  thinking: "Thinking",
  ...
  daysAgo: (n) => `${n}d ago`,
  messages: "messages",
  noApiKey: (p) => `No API key for ${p}. Go to Settings → Life Companion AI to configure.`,
...
const vi: I18n = {
  greeting: "Chào bạn! Mình là Life Companion AI. Hãy nhắn gì đó, hoặc gõ `/dive` để vào chế độ deep dive.",
  thinking: "Đang xử lý...",
  ...
  messages: "tin nhắn",
  noApiKey: (p) => `Chưa có API key cho ${p}. Vào Settings → Life Companion AI để cấu hình.`,
